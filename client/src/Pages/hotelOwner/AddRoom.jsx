    ...
    return (
        ...
        <form>
            <Title
                ...
                font='outfit'
                title='Add Room'
                subTitle='Fill in the details carefully. Provide accurate room details, pricing, and amenities to enhance the user booking experience.'
            />
            ...
            <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
                <div className='flex-1 max-w-48'>
                    ...
                    <select value={inputs.roomType} onChange={e => setInputs({ ...inputs, roomType: e.target.value })}
                        className='border opacity-70 border-gray-300 mt-1 rounded pt-2 w-full'>
                ...
                <div>
                    ...
                    <input type="number" placeholder='0' className='border border-gray-300 mt-1 rounded pt-1 w-24'
            ...
            <button className='bg-blue-600 text-white px-4 py-2 rounded mt-6 cursor-pointer'>Add Room</button>
        </form>
